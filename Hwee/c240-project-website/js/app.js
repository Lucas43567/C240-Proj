...
async function queryFlowise(question) {
    console.log('Calling Flowise API with question:', question);
    try {
        const response = await fetch("https://cloud.flowiseai.com/api/v1/prediction/e4723add-ad6f-4995-aca3-bfa8af411463", {
            method: "POST",
            headers: {
...
function addChatMessage(text, sender) {
    console.log('addChatMessage called with:', text, sender);
